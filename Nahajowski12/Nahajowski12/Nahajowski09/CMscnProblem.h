...
public:
	...
	double getMaxMin(int index, double *pdSolution, double *error, int length);
	...
	double bConstraintSatisfied(double *pdSolution, double *error, int length);
	void repair(double *pdSolution, double *error, int length);
